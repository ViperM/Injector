...
public class Main extends javafx.application.Application {
    ...
    /*TODO
    win - portable, mac - portable, linux - package
    readme -> packages + screenshots
    rethink variable patterns
    zoom in and zoom out buttons
    code duplicates - controllers and alerts
    unit tests
    prevent resize variables window
    refresh file after variables regex change - REFRESH
    narrower divider - ZABAWA
    save data after click, not after enter - 30m - https://docs.oracle.com/javafx/2/ui_controls/table-view.htm
*/
}
